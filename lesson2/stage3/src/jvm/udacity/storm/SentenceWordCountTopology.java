...
public class SentenceWordCountTopology {
  ...
  /**
   * A bolt that splits the sentences that it receives into words
   */
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    // attach the split sentence bolt
    builder.setBolt("split-sentence-bolt", new SplitSentenceBolt(), 5)
      .shuffleGrouping("sentence-spout");

    // attach the count bolt using fields grouping - parallelism of 15
    builder.setBolt("count-bolt", new CountBolt(), 15)
      .fieldsGrouping("split-sentence-bolt", new Fields("sentence-word"));
